    ...
    $("#pizza-one-form").submit((event) => {
      ...
      $("#size-price").text(
        chickenSupreme.size +
          ...
          ": " +
          "Ksh. " +
          chickenSupreme.priceBySize()
      );
      $("#crust-price").text(
        chickenSupreme.crust + ": " + "Ksh. " + chickenSupreme.crustPrice()
      );
      $("#toppings-price").text(
        chickenSupreme.toppings +
          " Toppings" +
          ": " +
          "Ksh. " +
          chickenSupreme.toppingsPrice()
      );
